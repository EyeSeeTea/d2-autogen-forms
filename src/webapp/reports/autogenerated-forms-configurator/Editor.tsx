...
export const Editor: React.FC<EditorProps> = React.memo(props => {
    const { handleEditorValidation, json, onChange, dataSetId } = props;
    const autogenConfigSchema = useAutogenSchema(dataSetId);
        ...
        loader
            ...
            .then((monaco: Monaco) => {
                monaco.languages.json.jsonDefaults.setDiagnosticsOptions({
                    validate: true,
                    schemas: [getAutogenConfigSchema({ ...autogenConfigSchema })],
                });
            })
