...
export function useConfigurator(): ConfiguratorState {
    ...
    const saveConfig = useCallback(async () => {
        ...
        await compositionRoot.dataStoreConfig
            ...
            .then(async () => {
                ...
                const fullDataSet = await compositionRoot.dataSet.getById(dataSet.id);
                if (fullDataSet.sections.length === 0) {
                    setPendingDataSet(fullDataSet);
    ...
    const confirmCreateSection = useCallback(async () => {
        ...
        await compositionRoot.dataSet
            ...
            .catch(error => snackbar.error(error.message))
            .finally(() => updateLoadingState(false));
    }, [compositionRoot.dataSet, pendingDataSet, snackbar]);
