...
export class GridWithCategoryColumnsViewModel {
    ...
    private static getColumns(section: SectionWithCategoryColumns): {
        ...
        const columns = dataElements.map((dataElement): Column => {
            ...
            const splitName = splitDataElementName(dataElement.name);
            const columnName = _.last(splitName) || "";
            const parentColumnName = splitName[0] || "";
                ...
                return _(combinations)
                    .map(combination => {
                        ...
                        return {
                            ...
                            disabled: !cocDetails || isToggleMultipleDeDisabled(section, dataElement, orgUnitCode),
