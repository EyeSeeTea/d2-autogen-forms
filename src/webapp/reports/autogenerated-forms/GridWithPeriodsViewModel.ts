...
import { getCategoryOptionComboByColumnName } from "./GridFormViewModel";
...
export class GridWithPeriodsViewModel {
        ...
        const summary = _(section.totals)
            .map((sectionTotal, key) => {
                const cellTotals = section.periods.map(column => {
                    ...
                    const columnWithDataElements = GridWithPeriodsViewModel.getColumnWithDataElements(
    ...
    private static getColumnWithDataElements(selectedDataElements: DataElement[], column: string): TotalItem[] {
