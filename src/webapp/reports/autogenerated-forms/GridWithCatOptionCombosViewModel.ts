...
export class GridWithCatOptionCombosViewModel {
    static get(section: Section, dataFormInfo: DataFormInfo): Grid {
        ...
        const columns: Column[] = _.orderBy(
            subsections.map(subsection => {
                const columnDescription = GridWithCatOptionCombosViewModel.getColumnDescription(
                    section,
                    dataFormInfo,
                    dataSetDataElements,
                    subsection.name
    ...
    private static getColumnDescription(
        section: Section,
        dataFormInfo: DataFormInfo,
        dataElements: DataElement[],
        subsectionName: string
    ): string | undefined {
        const description = section.columnsDescriptions ? section.columnsDescriptions[subsectionName] : undefined;
