...
import { AlertRule } from "../../components/alert-rule/AlertRule";
    ...
    return (
        <div ref={dataFormInfo.initForm}>
            ...
            {rules.length > 0 && (
                <AlertContainer>
                    {rules.map(rule => {
                        const isVisible = !ignoreRules.find(
                            ignoreRule =>
                                ignoreRule.validationRuleId === rule.validationRuleId &&
                                ignoreRule.message === rule.message
                        );
                        return (
                            <AlertRule
