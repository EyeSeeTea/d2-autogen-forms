...
import { useCustomRuleActions } from "./hooks/useCustomRuleActions";
import { Modal } from "../../components/modal/Modal";

const AutogeneratedForm: React.FC = () => {
    const [dataFormInfo, isLoading, rules, ignoreRules, onCloseAlert] = useDataFormInfo();
    const customRuleActions = useCustomRuleActions(dataFormInfo?.metadata.dataForm);
    ...
    return (
        <div ref={dataFormInfo.initForm}>
            ...
            {customRuleActions.displayWarning && (
                <Modal
                    dismissable={!customRuleActions.displayWarning.blockEntry}
                    text={customRuleActions.displayWarning.text}
...
function useDataFormInfo(): [
    ...
    const saveDataValue = useCallback<DataFormInfo["data"]["save"]>(
        async (dataValue: DataValue) => {
            ...
            await compositionRoot.dataForms.saveValue(dataValues, dataValue).then(newStore => {
                setDataValues(prev => {
    ...
    return [dataFormInfo, isLoading, rules, ignoreRules, onCloseAlert];
}
