...
import { DataSetDataStoreRepository } from "./data/autogenerated-forms-configurator/DataSetDataStoreRepository";
...
export function getCompositionRoot(api: D2Api) {
    ...
    const dataSetRepository = new DataSetDataStoreRepository(api);
