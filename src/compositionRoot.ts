...
import { GetSelectedDataSetUseCase } from "./domain/autogenerated-forms-configurator/usecases/GetSelectedDataSetUseCase";
...
export function getCompositionRoot(api: D2Api) {
    ...
    return {
        ...
        dataStoreConfig: getExecute({
            ...
            getSelectedDataSet: new GetSelectedDataSetUseCase(dataStoreConfigRepository),
        }),
        orgUnits: getExecute({
