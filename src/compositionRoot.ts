...
import { AutogenConfigD2Repository } from "./data/autogenerated-forms-configurator/AutogenConfigD2Repository";
...
export function getCompositionRoot(api: D2Api) {
    ...
    const dataStoreConfigRepository = new AutogenConfigD2Repository(api);
