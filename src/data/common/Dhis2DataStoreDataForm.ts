...
import { Namespaces, dataStoreNamespace, dataStoreNamespaceOld } from "./clients/storage/Namespaces";
...
export class Dhis2DataStoreDataForm {
    ...
    static async build(api: D2Api, dataSetCode?: string): Promise<Dhis2DataStoreDataForm> {
        ...
        if (!dataSetCode) dataStore = api.dataStore(dataStoreNamespaceOld);
