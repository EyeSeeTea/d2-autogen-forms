...
export function getColumnDescription(section: Section, dataFormInfo: DataFormInfo, columnName: string): Maybe<string> {
...
export function getGroupCellDescription(
    section: Section,
    dataFormInfo: DataFormInfo,
    groupName: string
): Maybe<string> {
    const description = section.groupDescriptions ? section.groupDescriptions[groupName] : undefined;
    const dataElements = dataFormInfo.metadata.dataForm.dataElements;
    if (!description) return undefined;
