...
async function getBaseUrl() {
    ...
    if (isDev) {
        return "/dhis2"; // Proxied to the DHIS2 instance by vite.config.ts (server.proxy)
    } else if (variant === "autogenerated-forms") {
        // There is manifest to read in data-entry APP, hardcoded to parent path
        return "..";
    } else {
        try {
