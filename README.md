...
Setting the environment variable `VITE_DEBUG=true` enables debug mode.
...
## Autogenerated forms configurator app

The configurator app allows to edit the JSON config for autogen-forms for each DataSet. It provides validations for the configuration object.

Create the autogenerated configurator app:

```
$ VITE_REPORT_VARIANT=autogenerated-forms-configurator yarn start # start dev server
